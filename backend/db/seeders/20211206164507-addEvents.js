...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Events', [
      ...
      { time: new Date('December 13, 2021 8:00:00'), title: 'Solo React Project Presentations', body: 'Big Day coming up. How is everybody going to be presenting?', userId: 1 },
      { time: new Date('December 25, 2021 0:00:00'), title: 'You Know', body: 'Even if you don\'t celebrate it, you know.', userId: 1 },], {});
  },
